...
\begin{frame}{Performance Bottlenecks}
  \begin{itemize}
    ...
    \begin{itemize}
      \item \textbf{API Overhead}: Remote solver calls introduced heavy latency. \textbf{Fix}: Migrated to a local solver instance.
      \item \textbf{Redundant Computation}: Identical crate configurations were being solved repeatedly, but implementing a standard cache was non-trivial.
    \end{itemize}
