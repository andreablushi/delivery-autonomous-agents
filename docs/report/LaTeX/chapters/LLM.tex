...
All team-level commands previously mentioned follow a uniform two-step pattern: the injection is applied to the LLM agent locally first, 
then packaged as a peer-injection message and broadcasted to all teammates.
This ensures that a single LLM command propagates atomically across the entire team.
